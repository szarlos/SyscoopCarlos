...
<div id="wrapper">
    ...
    <ul id="menu">
        <li>
		    ...
		    <li>
                        <a href="#">Cuotas</a>
                            <ul>
                                <li tex-align="reft"><?php echo anchor('cuotas', 'Buscar por Alumno'); ?> </li>
                                <li tex-align="reft"><?php echo anchor('cuotas', 'Buscar por Curso'); ?> </li>
                            </ul>
                    </li>
                </ul>
        </li>
	<li>
		...
		<ul>
                    ...
                    <li><?php echo anchor('liquidaciones', 'Honorarios'); ?> </li>
