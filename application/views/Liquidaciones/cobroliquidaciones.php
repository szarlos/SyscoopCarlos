...
<?php echo form_open('liquidaciones/cobrar/'.$id); ?>
<b>Profesor</b>
<fieldset>
<?php echo $table ?>   
</fieldset>
...
<div>
    ...
    <?php echo form_textarea('descripcion', set_value('descripcion',"Pago de Honorarios.--"), 'id="descripcion"'); ?>
    
</div>
<div>
    <label for="monto">Importe $ <span style="color:red;">*</span></label>
    <?php echo form_input('monto', set_value('monto',$liquidacion->Liq_Monto), 'id="monto"'); ?>
</div>
