...
<div id="wrapper">
    ...
    <header id="header" class="clearfix" role="banner">
        ...
        <hgroup>
            ...
            <h2 id="sideright"><small><?php echo $this->session->userdata('name'); ?></small></h2>
        </hgroup>
    </header> <!-- #header -->
    <ul id="menu">
       <li>
        <?php echo anchor('index/abrir_caja/', 'Abrir Caja'); ?> 
        </li>
	<li>
            <a href="#">Informes</a>
		<ul>
                    <li><?php echo anchor('rendiciones', 'Rendiciones Diarias'); ?> </li>
                    <!--<p> <?php echo anchor('index/otros_informes', 'Otros informes?'); ?> </p>-->
                </ul>
        </li>
        <li>
