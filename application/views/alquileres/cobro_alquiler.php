...
<?php echo form_open('alquileres/cobrar/'.$id); ?>
<b>Cliente</b>
<fieldset>
<?php echo $table ?>   
</fieldset>
...
<div>
    ...
    <?php echo form_textarea('descripcion', set_value('descripcion',"Alquiler $alquiler->Rec_Nombre.--"), 'id="descripcion"'); ?>
    
</div>
<div>
    <label for="monto">Importe $ <span style="color:red;">*</span></label>
    <?php echo form_input('monto', set_value('monto',$alquiler->Alq_Monto), 'id="monto"'); ?>
</div>
