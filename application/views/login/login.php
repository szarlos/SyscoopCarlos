   ...
   <fieldset>
    ...
    <div>
        <?php  echo form_label('Usuario', 'user');
                echo form_input(array('id'=>'usuario','name'=>'usuario')); ?>
    </div>
    <div>
        <?php  echo form_label('Contraseña', 'cont');
               echo form_password(array('id'=>'contrasena','name'=>'contrasena')); ?>
    </div>
       <div>
        <?php //mostrar error de usuario usando la session flashdata
        if (($this->session->flashdata('login_error'))==TRUE) {
            echo 'Ingresó un usuario o password incorrecto';
        }
        echo validation_errors(); ?>
        <?php echo form_submit(array('name'=>'submit'),'Entrar'); ?>
