    ...
    <style>
                ...
                */
                ...
                #site-description {
                 ...
                 #site-description2 {
                         font: normal 25px 'Droid Serif', sans-serif;
                       float: center;
                        padding-top: 10px;
                }
                /**
...
<div id="wrapper">
    ...
    <header id="header" class="clearfix" role="banner">
        ...
        <hgroup>
            ...
            <h2 id="site-description">monica umeres</h2>
            <h1 id="site-description2" align="center"></h1>
        </hgroup>
    </header> <!-- #header -->
     <ul id="menu">
        <li>
...
<?php echo form_error('name'); ?>
			...
			<tr>
				<td valign="top">Dni<span style="color:red;">*</span></td>
				<td><input type="text" name="name" class="text" value="<?php echo set_value('name',$this->form_data->name); ?>"/>
<?php echo form_error('name'); ?>
				</td>
			</tr>
			<tr>
				<td valign="top">Fecha de Nacimiento (dd-mm-aaaa)<span style="color:red;">*</span></td>
